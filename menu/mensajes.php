...
<div class="panelVentana">
    ...
    <div class="tituloVentana">Mensajes</div>

	<div class="menu">
		
		<ul class="menu__tabs">
			<li><a class="active" href="#item-1"><i class="fa fa-comment-plus"></i>Enviar</a></li>
			<li><a href="#item-2"><i class="fal fa-comment-lines"></i>Enviados</a></li>
