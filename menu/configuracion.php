...
<div class="panelVentana">
    ...
    <div class="tituloVentana">Configuracion</div>

	<div class="menu">
		
		<ul class="menu__tabs">
			<li><a class="active" href="#item-1"><i class="fa fa-cogs"></i>Configuracion</a></li>
			<li><a href="#item-2"><i class="fal fa-user-graduate"></i>Carreras</a></li>
