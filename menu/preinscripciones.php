...
<div class="panelVentana">
	<div class="tituloVentana">Pre-inscripciones</div>

	<div class="menu">
		
		<ul class="menu__tabs">
			<li><a class="active" href="#item-1"><i class="fa fa-user"></i>Bancaria</a></li>
			<li><a href="#item-2"><i class="fa fa-user"></i>Turismo</a></li>
