...
<div class="panelVentana">
	<div class="tituloVentana">Materias</div>

	<div class="menu">
		
		<ul class="menu__tabs">
			<li><a class="active" href="#item-1"><i class="fa fa-books"></i>Materias</a></li>
			<li><a href="#item-2"><i class="fab fa-stack-overflow"></i>Correlativas</a></li>
