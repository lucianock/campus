...
<div class="panelVentana">
	<div class="tituloVentana">Novedades</div>

	<div class="menu">
		
		<ul class="menu__tabs">
			<li><a class="active" href="#item-1"><i class="fa fa-newspaper"></i>Publicadas</a></li>
			<li><a href="#item-2"><i class="fab fa-stack-overflow"></i>######</a></li>
