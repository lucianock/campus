...
<div class="panelVentana">
	<div class="tituloVentana">Inscripciones</div>

	<div class="menu">
		
		<ul class="menu__tabs">
			<li><a class="active" href="#item-1"><i class="fa fa-user"></i>Ingresantes</a></li>
			<li><a href="#item-2"><i class="fas fa-recycle"></i>Reinscripciones</a></li>
